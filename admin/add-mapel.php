		...
		<fieldset>
			...
			<form class="form-horizontal" method="post" action="" name="frm" id="frm">
				<div class="input-group">
					...
					<input type="text" class="form-control" name="mapel" placeholder="MATA PELAJARAN" size="50" style="text-align: left;">
				</div>
				</br>
				<div class="input-group">
					<span class="input-group-addon" id="basic-addon1" style="min-width: 120px; text-align: left;"><b>JENJANG</b></span>
					<select class="form-control form-select form-select-lg mb-3" aria-label=".form-select-lg example" name="jurusan">
					...
					<!-- <input type="text" class="form-control" name="jenjang" placeholder="JENJANG" size="50" style="text-align: left;"> -->
				</div>
				</br>
				<div class="input-group">
					<span class="input-group-addon" id="basic-addon1" style="min-width: 120px; text-align: left;"><b>URUTAN</b></span>
					<input type="number" class="form-control" name="urutan" placeholder="URUTAN" size="50" style="text-align: left;">
				</div>
				</br>
