                ...
                <td style="padding: 10px;">
                    ...
                    <div class="container" style="height: 100%; display: flex; justify-content: center; align-items: center;">
                        <div style="top: 50%; transform:translate(0, -50%); position: absolute;">
                            <div class="well">
                                <p align="center"><img src="images/logo_sekolah.png" height="75" /></p>
                                ...
                                <script>
                                    function cekNo() {
                                        ...
                                        if (cek == null || cek == "") {
                                            alert("SILAHKAN MASUKKAN NOMOR UJIAN");
                                            return false;
                                        }
                                    }
                                </script>
                                    ...
                                    <form class="form-horizontal" form name="formcarino" method="post" action="carinisn" onSubmit="return cekNo()">
                                        <fieldset id="xpengumuman">
                                            <div class="form-group">
                                                <input type="text" class="form-control" name="noujian" placeholder="KETIK/MASUKKAN NOMOR UJIAN" size="auto">
                                            </div>
